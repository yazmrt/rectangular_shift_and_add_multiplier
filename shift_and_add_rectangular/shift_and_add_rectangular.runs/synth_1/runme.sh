...
HD_PWD='C:/Users/yazmr/OneDrive/Masast/Vivado Codes/shift_and_add_rectangular/shift_and_add_rectangular.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ShiftAdd_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ShiftAdd_Top.tcl
